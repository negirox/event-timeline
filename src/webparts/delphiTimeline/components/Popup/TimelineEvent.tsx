...
export class TimelineEvent extends React.Component<IEventProps, IEventState> {
  ...
  private _onActivityPictureURLChange = (ev: any, newText: string): void => {
    const newUrl : ActivityLink ={ Url : newText, Description : ''}
    this.setState({ eventData: { ...this.state.eventData, activityPictureUrl: newUrl } });
  }

  private _onActivityLinkURLChange = (ev: any, newText: string): void => {
    const newUrl : ActivityLink ={ Url : newText, Description : ''}
    this.setState({ eventData: { ...this.state.eventData, activityLink: newUrl } });
  }
  ...
  private onDescriptionChange = (e:any): void => {
