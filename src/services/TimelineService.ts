    ...
    public async addTimelineActivity(listId: string, newTimelineActivity: ITimelineActivity) {
        try {
            let addData: ITypedHash<any> = {
                ...
                SPFxTimelineLink: null,
                SPFxTimelinePicture: null
            };
    ...
    public async updateTimelineActivity(listId: string, updateTimelineActivity: ITimelineActivity) {
        try {
            ...
            if (updateTimelineActivity.activityLink) {
                let linkUrl = updateTimelineActivity.activityLink ? updateTimelineActivity.activityLink : updateTimelineActivity.activityLink;
            ...
            if (updateTimelineActivity.activityPictureUrl) {
                let picUrl = updateTimelineActivity.activityPictureUrl ? updateTimelineActivity.activityPictureUrl : updateTimelineActivity.activityPictureUrl;
